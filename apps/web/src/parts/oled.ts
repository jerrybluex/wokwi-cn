 ...
 *   Pin 'sda' — I2C data
 *
 * Stub model: exposes I2C bus reads/writes for future buffer support.
 * Real pixel buffer simulation lands in Phase 3.
 */
